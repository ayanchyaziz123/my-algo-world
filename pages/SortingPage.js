...
import { bubble_sort, selection_sort, insertion_sort  } from '../algorithms/Sorting';
import SortingVisualizer  from '../visualizers/SortingVisulizer';
            ...
            <Box sx={{ flexGrow: 1 }}>
                <Grid container columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                    ...
                    <Grid item xs={12} sm={9}>
                        <SortingVisualizer data={this.state.array} colorKey={this.state.colorKey} />
                        {
